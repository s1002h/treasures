...
/**
 * shiro配置项 Created by Lucare.Feng on 2017/3/6.
 */
@Configuration
public class ShiroConfiguration {
	...
	/*
	 * @Bean(name = "shiroDialect") public ShiroDialect shiroDialect(){ return
	 * new ShiroDialect(); }
	 */
